...
(function (PianificazioneTurni) {
    PianificazioneTurni.IndexVueModel.prototype.collegaAllaPianificazioneCondivisa = function () {
        const self = this;
        ...
        gestore.connection.on('PianificazioneModificata', async (descrizione, autore) => {
            ...
            if (!eMia) {
                PianificazioneTurni.mostraMessaggio('informazione', autore
...
//# sourceMappingURL=Index.Collaborazione.js.map