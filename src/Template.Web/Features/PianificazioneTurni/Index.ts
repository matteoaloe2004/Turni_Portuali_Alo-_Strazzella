...
module PianificazioneTurni {
    ...
    export class IndexVueModel {
        ...
        private eseguiAssegnazioneTask(operatoreNome: string, banchina: string, startOra: number, giorno: number): void {
        ...
        public getDettaglioConflittoOperatore(op: any): ConflittoOperatore {
        ...
        private static readonly CONFLICT_WARNING_LABELS: { [key in ConflictWarning]: string } = {
        ...
        public formatDettaglioConflitto(conflitto: ConflittoOperatore): string {
